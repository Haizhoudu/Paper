...
\newcommand\controller{{CLPE}}
\newcommand{\css}[1]{\textcolor{red}{[css: #1]}}
...
\title{Hummingbird: A Novel Approach of Adaptively the Spark Configurations for Big Data Analytics}
